...
module "docker_reverse_proxy" {
  source = "./infra/packages/docker-reverse-proxy"
...
module "client_proxy" {
  source = "./infra/packages/client-proxy"
